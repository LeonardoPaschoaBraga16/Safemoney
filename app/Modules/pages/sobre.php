    ...
    <section class="origin section">
        <div class="container">
            <div class="origin__content">
                ...
                <div class="origin-flow" aria-label="Dificuldade, reflexão, ideia e SafeMoney">
        ...
        <div class="container">
            <div class="vision-card surface-card">
                ...
                <div class="vision-card__actions">
                    <a class="button button--outline" href="materiais.html">
                        <span class="material-symbols-outlined">menu_book</span>
                        Conhecer nossos materiais
                    </a>
                    <a class="button button--accent" href="tracker.html">
                        <span class="material-symbols-outlined">monitoring</span>
