...
<head>
    ...
    <title>SafeMoney - Nossos Objetivos</title>
        ...
        <section class="learning-path section">
            <div class="container learning-path__inner">
                <div class="section-heading learning-path__heading">
                    ...
                    <a class="button button--accent" href="materiais.html">
        ...
        <section class="journey section">
            <div class="container">
                ...
                <div class="journey__timeline">
                    <div class="journey__progress" aria-hidden="true"></div>
        ...
        <section class="tracker-preview section section--muted">
            <div class="container tracker-preview__grid">
                ...
                <div class="tracker-preview__content">
                    ...
                    <a class="button button--outline" href="tracker.html">
        ...
        <section class="final-cta section">
            <div class="container final-cta__content">
                ...
                <div class="final-cta__actions">
                    <a class="button button--primary" href="materiais.html">Acessar Materiais</a>
                    <a class="button button--outline" href="tracker.html">Testar Tracker</a>
                </div>
            </div>
        </section>
    </main>
