...
$pageTitle = 'Tipos de investimentos';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <meta name="description" content="Tipos de investimentos - material educativo da SafeMoney.">
    <title>Tipos de investimentos - SafeMoney</title>
            ...
            <article class="material-reader material-reader--standalone">
                ...
                <div class="material-article material-article--placeholder">
                    <div class="material-placeholder">
                        <span class="material-placeholder__icon material-symbols-outlined" aria-hidden="true">category</span>
                ...
                <nav class="material-pagination" aria-label="Navegação entre materiais">
                    <a class="pagination-button pagination-button--previous" href="historia-dos-investimentos.php">
            <span class="material-symbols-outlined" aria-hidden="true">arrow_back</span>
            <span>Anterior</span>
        </a>
                    <a class="pagination-button pagination-button--next" href="renda-fixa.php">
