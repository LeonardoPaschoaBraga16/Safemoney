...
$pageTitle = 'Glossário financeiro';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <meta name="description" content="Glossário financeiro - material educativo da SafeMoney.">
    <title>Glossário financeiro - SafeMoney</title>
            ...
            <article class="material-reader material-reader--standalone">
                ...
                <div class="material-article material-article--placeholder">
                    <div class="material-placeholder">
                        <span class="material-placeholder__icon material-symbols-outlined" aria-hidden="true">menu_book</span>
                ...
                <nav class="material-pagination" aria-label="Navegação entre materiais">
                    <a class="pagination-button pagination-button--previous" href="como-utilizar-o-investment-tracker.php">
            <span class="material-symbols-outlined" aria-hidden="true">arrow_back</span>
            <span>Anterior</span>
        </a>
