...
<head>
    ...
    <meta name="description" content="Por que investir? - material educativo da SafeMoney.">
    <title>Por que investir? - SafeMoney</title>
            ...
            <article class="material-reader material-reader--standalone">
                ...
                <div class="material-article material-article--placeholder">
                    <div class="material-placeholder">
                        <span class="material-placeholder__icon material-symbols-outlined" aria-hidden="true">lightbulb</span>
                ...
                <nav class="material-pagination" aria-label="Navegação entre materiais">
                    <a class="pagination-button pagination-button--previous" href="o-que-e-investir.php">
            <span class="material-symbols-outlined" aria-hidden="true">arrow_back</span>
            <span>Anterior</span>
        </a>
                    <a class="pagination-button pagination-button--next" href="historia-dos-investimentos.php">
