...
$pageTitle = 'História dos investimentos';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <meta name="description" content="História dos investimentos - material educativo da SafeMoney.">
    <title>História dos investimentos - SafeMoney</title>
        ...
        <div class="container">
            <article class="material-reader material-reader--standalone">
                <header class="material-reader__header">
                    ...
                    <h1>História dos investimentos</h1>
                ...
                <div class="material-article material-article--placeholder">
                    <div class="material-placeholder">
                        <span class="material-placeholder__icon material-symbols-outlined" aria-hidden="true">history</span>
                ...
                <nav class="material-pagination" aria-label="Navegação entre materiais">
                    <a class="pagination-button pagination-button--previous" href="por-que-investir.php">
            <span class="material-symbols-outlined" aria-hidden="true">arrow_back</span>
            <span>Anterior</span>
        </a>
                    <a class="pagination-button pagination-button--next" href="tipos-de-investimentos.php">
