...
<head>
    ...
    <meta name="description" content="Criptomoedas - material educativo da SafeMoney.">
    <title>Criptomoedas - SafeMoney</title>
            ...
            <article class="material-reader material-reader--standalone">
                ...
                <div class="material-article material-article--placeholder">
                    <div class="material-placeholder">
                        <span class="material-placeholder__icon material-symbols-outlined" aria-hidden="true">currency_bitcoin</span>
                ...
                <nav class="material-pagination" aria-label="Navegação entre materiais">
                    <a class="pagination-button pagination-button--previous" href="renda-variavel.php">
            <span class="material-symbols-outlined" aria-hidden="true">arrow_back</span>
            <span>Anterior</span>
        </a>
                    <a class="pagination-button pagination-button--next" href="riscos-dos-investimentos.php">
