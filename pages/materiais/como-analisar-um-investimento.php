...
$pageTitle = 'Como analisar um investimento?';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <meta name="description" content="Como analisar um investimento? - material educativo da SafeMoney.">
    <title>Como analisar um investimento? - SafeMoney</title>
        ...
        <div class="container">
            <article class="material-reader material-reader--standalone">
                <header class="material-reader__header">
                    ...
                    <h1>Como analisar um investimento?</h1>
                ...
                <div class="material-article material-article--placeholder">
                    <div class="material-placeholder">
                        <span class="material-placeholder__icon material-symbols-outlined" aria-hidden="true">analytics</span>
                ...
                <nav class="material-pagination" aria-label="Navegação entre materiais">
                    <a class="pagination-button pagination-button--previous" href="como-comecar-a-investir.php">
            <span class="material-symbols-outlined" aria-hidden="true">arrow_back</span>
            <span>Anterior</span>
        </a>
                    <a class="pagination-button pagination-button--next" href="como-utilizar-o-investment-tracker.php">
