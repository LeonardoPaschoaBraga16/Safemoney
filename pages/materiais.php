...
<head>
    ...
    <meta name="description" content="Materiais educativos da SafeMoney sobre investimentos, segurança e primeiros passos.">
    <title>Materiais - SafeMoney</title>
...
<main class="materials-page">
    <section class="materials-hero">
        <div class="container materials-hero__content">
            <span class="materials-hero__eyebrow">Centro de Conhecimento</span>
            <h1 class="display-title">Nossos Materiais</h1>
            ...
            <p class="materials-hero__description">
                Explore os conteúdos abaixo e construa sua base de conhecimento antes de avançar para conceitos mais complexos.
            </p>
        </div>
    </section>
        ...
        <div class="container materials-content__grid">
            <aside class="materials-sidebar" aria-label="Categorias de materiais">
                <div class="materials-sidebar__inner">
                    <h2 class="materials-sidebar__title">Materiais</h2>
                    <div class="materials-menu">
                        <section class="material-group">
            <h2 class="material-group__title">Fundamentos</h2>
            <ul class="material-list">
                <li>
                <a class="material-link" href="materiais/o-que-e-investir.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">auto_stories</span>
                    <span>O que é investir?</span>
                </a>
            </li><li>
                <a class="material-link" href="materiais/por-que-investir.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">lightbulb</span>
                    <span>Por que investir?</span>
                </a>
            </li><li>
                <a class="material-link" href="materiais/historia-dos-investimentos.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">history</span>
                    <span>História dos investimentos</span>
                </a>
            </li>
            </ul>
        </section><section class="material-group">
            <h2 class="material-group__title">Tipos de Investimento</h2>
            <ul class="material-list">
                <li>
                <a class="material-link" href="materiais/tipos-de-investimentos.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">category</span>
                    <span>Tipos de investimentos</span>
                </a>
            </li><li>
                <a class="material-link" href="materiais/renda-fixa.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">account_balance</span>
                    <span>Renda Fixa</span>
                </a>
            </li><li>
                <a class="material-link" href="materiais/renda-variavel.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">trending_up</span>
                    <span>Renda Variável</span>
                </a>
            </li><li>
                <a class="material-link" href="materiais/criptomoedas.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">currency_bitcoin</span>
                    <span>Criptomoedas</span>
                </a>
            </li>
            </ul>
        </section><section class="material-group">
            <h2 class="material-group__title">Segurança</h2>
            <ul class="material-list">
                <li>
                <a class="material-link" href="materiais/riscos-dos-investimentos.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">warning</span>
                    <span>Riscos dos investimentos</span>
                </a>
            </li><li>
                <a class="material-link" href="materiais/seguranca-ao-investir.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">shield</span>
                    <span>Segurança ao investir</span>
                </a>
            </li>
            </ul>
        </section><section class="material-group">
            <h2 class="material-group__title">Primeiros Passos</h2>
            <ul class="material-list">
                <li>
                <a class="material-link" href="materiais/como-comecar-a-investir.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">rocket_launch</span>
                    <span>Como começar a investir?</span>
                </a>
            </li><li>
                <a class="material-link" href="materiais/como-analisar-um-investimento.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">analytics</span>
                    <span>Como analisar um investimento?</span>
                </a>
            </li>
            </ul>
        </section><section class="material-group">
            <h2 class="material-group__title">SafeMoney</h2>
            <ul class="material-list">
                <li>
                <a class="material-link" href="materiais/como-utilizar-o-investment-tracker.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">monitoring</span>
                    <span>Como utilizar o InvestmentTracker?</span>
                </a>
            </li><li>
                <a class="material-link" href="materiais/glossario-financeiro.php">
                    <span class="material-link__icon material-symbols-outlined" aria-hidden="true">menu_book</span>
            ...
            <article class="material-reader">
                ...
                <div class="material-article">
                    ...
                    <h3>O Conceito de Investimento</h3>
                    ...
                    <aside class="material-highlight">
                        <span class="material-highlight__icon material-symbols-outlined" aria-hidden="true">lightbulb</span>
                    ...
                    <h3>Por que não deixar o dinheiro parado?</h3>
                    ...
                    <figure class="material-image">
                        <div class="material-image__placeholder" role="img"
                ...
                <nav class="material-pagination" aria-label="Navegação entre materiais">
                    ...
                    <a class="pagination-button pagination-button--next" href="materiais/por-que-investir.php">
    ...
    <section class="materials-cta">
        <div class="container">
            <div class="materials-cta__card">
                <div class="materials-cta__decoration materials-cta__decoration--top" aria-hidden="true"></div>
                <div class="materials-cta__decoration materials-cta__decoration--bottom" aria-hidden="true"></div>

                <div class="materials-cta__content">
                    <span class="materials-cta__icon material-symbols-outlined" aria-hidden="true">monitoring</span>
                    <h2>Quer acompanhar o mercado?</h2>
                    <p>
                        Conheça o InvestmentTracker e aprenda a acompanhar informações sobre diferentes
                        ativos com nossa ferramenta.
                    </p>
                    <a class="button button--gold" href="tracker.php">Conhecer o InvestmentTracker</a>
                </div>
            </div>
        </div>
    </section>
